...
public class Clerk extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(0, 200, 200));
        ...
        jButton2.setBackground(new java.awt.Color(0, 200, 200));
        jButton2.setText("Enter Purchase");
        ...
        jButton3.setBackground(new java.awt.Color(0, 200, 200));
        jButton3.setText("Issue Ingredient");
        ...
        logout.setBackground(new java.awt.Color(0, 200, 200));
